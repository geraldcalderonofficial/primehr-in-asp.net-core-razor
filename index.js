...
window.JsFunctions = {
    OpenReport: function (colorInfo, reportName) {
        var data = { ReportName: reportName };
        var object = $.extend(colorInfo, data);
        this._viewerOptions.reportUrl(JSON.stringify(object));
